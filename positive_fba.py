...
LHS, equalities, RHS, variable_types, lbs, ubs, objective = pcbm._buildPositiveFBA(
    Smatrix, lbs, ubs, objective)  # Build matrix problem
...
flux = analyse._extract_flux_patterns_from_PositiveFBA(

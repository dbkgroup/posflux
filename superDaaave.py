...
Smatrix, num_species, num_reactions, reaction_names, lbs, ubs, rxn_mean_expression, rxn_stdev_expression = sbml_data_mapper._read_and_map_sbml_and_expression_data(model,data,'D-glucose exchange',16.5)
...
LHS,equalities,RHS,variable_types,lbs,ubs,objective = pcbm._buildSuperDaaave(Smatrix,lbs,ubs,rxn_mean_expression,rxn_stdev_expression)	#Build matrix problem
...
flux = analyse._extract_flux_patterns_from_SuperDaaave(LPsolved,num_reactions)															#Extract flux pattern
